...
async function syncAttendance() {
  try {
    // 1. Test local connectivity to ZKTeco MB20 device
    ...
    console.log(`[${new Date().toLocaleTimeString('ar-EG')}] 🟢 جهاز البصمة متصل. جلب حركات الحضور الجديدة وتفريغها بالسيرفر السحابي...`);

    // 2. Send request to VPS backend to process sync
